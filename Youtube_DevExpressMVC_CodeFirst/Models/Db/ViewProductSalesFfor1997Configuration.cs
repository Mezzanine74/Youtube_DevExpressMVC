...
namespace YoutubeDevExpressMVC.Web.Models.Db
{
    ...
    public class ViewProductSalesFfor1997Configuration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ViewProductSalesFfor1997>
    {
        public ViewProductSalesFfor1997Configuration()
            : this("dbo")
        {
        }

        public ViewProductSalesFfor1997Configuration(string schema)
        {
            ToTable("ViewProductSalesFfor1997", schema);
